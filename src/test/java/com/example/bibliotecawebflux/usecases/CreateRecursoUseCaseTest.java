...
class CreateRecursoUseCaseTest {
    ...
    CreateRecursoUseCase createRecursoUseCase;

    @BeforeEach
    public void setUp() throws Exception {
        recursoRepository = Mockito.mock(IRecursoRepository.class);
        createRecursoUseCase = new CreateRecursoUseCase(recursoRepository);
    }
    ...
    void apply() {
        ...
        StepVerifier.create(createRecursoUseCase.apply(recurso))
                .expectNext(recurso)
                .verifyComplete();
